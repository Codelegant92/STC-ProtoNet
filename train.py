...
if __name__=='__main__':
    ...
    if params.method in ['baseline', 'baseline++'] :
    ...
    elif params.method in ['protonet','matchingnet','relationnet', 'relationnet_softmax', 'maml', 'maml_approx', 'reptile']:
        ...
        if params.method in ['maml', 'maml_approx', 'reptile']:
            base_datamgr            = SetDataManager(image_size,  n_support=params.train_n_shot, n_eposide=1600, **train_few_shot_params)
        else:
    ...
    if params.method == 'maml' or params.method == 'maml_approx' or params.method == 'reptile':
