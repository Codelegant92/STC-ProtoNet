...
class BaselineFinetune(MetaTemplate):
    def __init__(self, model_func,  n_way, n_query, max_n_way, min_n_way, max_shot, min_shot, fixed_way, n_support, loss_type = "softmax"):
        super(BaselineFinetune, self).__init__( model_func,  n_way, n_query, max_n_way, min_n_way, max_shot, min_shot, fixed_way)
